...
- Google Mobile Ads is pinned from v13.0.0 and currently resolves to 13.2.0. Debug builds use Google's current iOS demo ad unit IDs: banner (`ca-app-pub-3940256099942544/2435281174`), interstitial (`ca-app-pub-3940256099942544/4411468910`), rewarded (`ca-app-pub-3940256099942544/1712485313`), and rewarded interstitial (`ca-app-pub-3940256099942544/6978759866`).
