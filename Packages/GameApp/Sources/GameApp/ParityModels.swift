            ...
            if forceBehind || Double.random(in: 0...1) < 0.45 {
                ...
                if Double.random(in: 0...1) < 0.80 {
                    var closersWithWeights: [(String, Double)] = [
                        ...
                        ("Your stats are completely irrelevant.", 0.1),
        ...
        if isAddRequest {
            ...
            if Double.random(in: 0...1) < 0.45 * 0.86 {
                ...
                let behindCompReactionsWithWeights: [(String, Double)] = [
                    ...
                    ("Sure, add me. Don't get too comfortable up there.", 67.0),
                        ...
                        if wantsBetter {
                            ...
                            if higherIdx < mIdx {
                                ...
                                replies.append(contentsOf: [
                                    ...
                                    "I didn't like sharing the top spot. I'm at \(higherM) now.",
                    ...
                    if isLowerStreakBrag, let cN = commentNumber, let rN = refNumber {
                        ...
                        if higherNum < cN {
                            ...
                            replies.append(contentsOf: [
                                ...
                                "I didn't like sharing the top spot. I'm at \(higherNum) days now.",
                    ...
                    let cTimeStr = "\(cT.0):\(String(format: "%02d", cT.1))"
                        ...
                        if mySecs > cSecs {
                            ...
                            replies.append(contentsOf: [
                                ...
                                "I didn't like sharing the top spot. I'm at \(myTimeStr) now.",
                        ...
                        if higherNum > totalSecs {
                            ...
                            if wantsBetter {
                                ...
                                var templates = [
                                    ...
                                    "I didn't like sharing the top spot. I'm at \(higherTime) now.",
                    ...
                    if isLowerHoFBrag, let cN = commentNumber, let rN = refNumber {
                        ...
                        if wantsBetter {
                            ...
                            replies.append(contentsOf: [
                                ...
                                "I didn't like sharing the top spot. I'm at \(higherNum) entries now.",
