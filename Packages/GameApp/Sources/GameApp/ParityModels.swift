        ...
        if isCompetitive {
            ...
            if parentIsJealous {
                ...
                if let m = mentionedMilestone {
                    ...
                    replies.append("Your \(m.name) is a joke. Try catching my \(higherM).")
                    ...
                    replies.append("You actually think \(num) is a high score? Try hitting \(higherNum) easily like me.")
