...
public final class WheelEngine {
    ...
    public static let defaultSegments: [WheelSegment] = [
        ...
        .init(title: "4X Boost", subtitle: "12h multiplier", icon: "⚡️", iconAssetName: "boost4x", shortLabel: "4X",
        ...
        .init(title: "3X Boost", subtitle: "18h multiplier", icon: "⚡️", iconAssetName: "boost3x", shortLabel: "3X",
        ...
        .init(title: "2X Boost", subtitle: "24h multiplier", icon: "⚡️", iconAssetName: "boost2x", shortLabel: "2X",
