...
public final class WheelEngine {
    ...
    public static let defaultSegments: [WheelSegment] = [
        ...
        .init(title: "500 Gems", subtitle: "Big payout", icon: "💎", iconAssetName: "GemBagIcon", shortLabel: "500",
        ...
        .init(title: "1000 Gems", subtitle: "Jackpot", icon: "💎", iconAssetName: "GemBagIcon", shortLabel: "1000",
