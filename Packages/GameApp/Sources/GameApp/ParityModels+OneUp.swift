        ...
        case "time":
            ...
            case 3:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("You fell for it. I easily beat your \(lower). My real record is \(higher).", 19.9),
                    ("You thought I clocked slower than \(lower)? Cute. I now clocked \(higher).", 24.9),
        ...
        case "streak":
            ...
            case 3:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("You thought I was lower than \(lower) days? Cute. I'm now at \(higher) days.", 24.9),
        ...
        case "hof":
            ...
            case 3:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("You thought I was lower than \(lower) infinities? Cute. I'm now at \(higher) infinities.", 24.9),
