        ...
        case "milestone":
            ...
            case 3:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("I was just warming up. Your \(lower) is nothing compared to my \(higher).", 24.9),
            ...
            case 4:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("I've already passed \(lower). I am sitting at \(higher).", 0.24),
                    ...
                    ("You're celebrating \(lower)? I already cleared \(higher).", 54.99),
                    ("I left \(lower) in the dust. \(higher) is the new standard.", 6.0),
                    ("You're bragging about \(lower) while my \(higher) remains completely out of your reach.", 6.0),
                    ("I already hit \(higher). \(lower) is old news.", 8.0)
                ]
                return pickWeighted(weightedReplies)
            default: return ""
            }
        ...
        case "streak":
            ...
            case 3:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("I was just warming up. Your \(lower) days is nothing compared to my \(higher) days.", 24.9),
        ...
        case "hof":
            ...
            case 3:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("I was just warming up. Your \(lower) infinities is nothing compared to my \(higher) infinities.", 24.9),
