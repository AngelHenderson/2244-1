        ...
        case "milestone":
            ...
            case 3:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("You thought I was at \(lower)? Cute. I'm now at \(higher).", 24.9),
        ...
        case "time":
            ...
            case 3:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("You fell for it. I easily beat your \(lower). My real record is \(higher).", 19.9),
                    ("You thought I clocked \(lower)? Cute. I now clocked \(higher).", 24.9),
        ...
        case "streak":
            ...
            case 3:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("You thought I was at \(lower) days? Cute. I'm now at \(higher) days.", 24.9),
