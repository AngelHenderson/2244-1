        ...
        case "milestone":
            ...
            case 3:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("You're not even close. Your \(lower) is nothing compared to my \(higher).", 24.9),
        ...
        case "streak":
            ...
            case 3:
                let weightedReplies: [(String, Double)] = [
                    ...
                    ("You're not even close. Your \(lower) days is nothing compared to my \(higher) days.", 24.9),
